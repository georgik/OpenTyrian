...
{
    Uint8 *src = (Uint8 *) src_surface->pixels, *dst = (Uint8 *) dst_surface->pixels;
...
{
    Uint8 *src = (Uint8 *) src_surface->pixels, *src_temp, *dst = (Uint8 *) dst_surface->pixels, *dst_temp;
    int src_pitch = src_surface->pitch, dst_pitch = dst_surface->pitch;
