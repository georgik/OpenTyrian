...
void hq2x_32(SDL_Surface *src_surface, SDL_Surface *dst_surface)
{
    ...
    for (int j = 0; j < height; j++)
    {
        ...
        for (int i = 0; i < width; i++)
        {
            ...
            for (int k=1; k<=9; k++)
                c[k] = rgb_palette[w[k]] & 0xfcfcfcfc; // hq2x has a nasty inability to accept more than 6 bits for each
    component
...
void hq3x_32(SDL_Surface *src_surface, SDL_Surface *dst_surface)
{
    ...
    for (int j = 0; j < height; j++)
    {
        ...
        for (int i = 0; i < width; i++)
        {
            ...
            for (int k=1; k<=9; k++)
                c[k] = rgb_palette[w[k]] & 0xfcfcfcfc; // hq3x has a nasty inability to accept more than 6 bits for each
    component
...
void hq4x_32(SDL_Surface *src_surface, SDL_Surface *dst_surface)
{
    ...
    for (int j = 0; j < height; j++)
    {
        ...
        for (int i = 0; i < width; i++)
        {
            ...
            for (int k=1; k<=9; k++)
                c[k] = rgb_palette[w[k]] & 0xfcfcfcfc; // hq4x has a nasty inability to accept more than 6 bits for each
    component
