...
Uint16 network_player_port = NET_PORT, network_opponent_port = NET_PORT;

static char empty_string[] = "";
char *network_player_name = empty_string, *network_opponent_name = empty_string;
...
UDPpacket *packet_in[NET_PACKET_QUEUE] = {NULL}, *packet_out[NET_PACKET_QUEUE] = {NULL};
...
int network_state_send(void)
{
    ...
    if(network_delay > 1 && (last_state_out_sync + 1) % network_delay == 0 &&
       packet_state_out[network_delay - 1] != NULL) {
