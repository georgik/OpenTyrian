 ...
 *        the text.)
 */
void draw_font_hv_shadow(SDL_Surface *surface,
                         int x,
                         int y,
                         const char *text,
                         Font font,
 ...
 */
void draw_font_hv_full_shadow(SDL_Surface *surface,
                              int x,
                              int y,
                              const char *text,
                              Font font,
 ...
 */
void draw_font_hv(
    SDL_Surface *surface, int x, int y, const char *text, Font font, FontAlignment alignment, Uint8 hue, Sint8 value)
{
    switch(alignment) {
        case left_aligned:
            break;
 ...
 */
void draw_font_dark(
    SDL_Surface *surface, int x, int y, const char *text, Font font, FontAlignment alignment, bool black)
{
    switch(alignment) {
        case left_aligned:
            break;
