> :warning: This is **No Graphical version** of m5stack_core_s3 BSP. If you want to use this BSP with LVGL use [m5stack_core_s3](https://components.espressif.com/components/espressif/m5stack_core_s3) component.
# BSP: M5Stack CoreS3
